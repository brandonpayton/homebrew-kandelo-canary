...
class KandeloFormulaSupportTest < Minitest::Test
  ...
  def test_formulae_use_requirements_for_every_allowlisted_publisher_tool
    ...
    support_require =
      %Q(require (Tap.fetch("brandonpayton", "kandelo-canary").path/"Kandelo/formula_support/kandelo_formula_support").to_s\n)
    used = []
    ...
    assert_equal [
      {
        ...
        "tap_commit"     => REVIEWED_CORE_TAP_COMMIT,
      },
    ], dependency_taps.fetch("taps")
  end
